...
improved_vae_train_acc = np.genfromtxt('improved_vae_0/training_acc.csv')
...
plt.plot(np.array(range(len(improved_vae_train_acc))) + 1, improved_vae_train_acc, label='improved+aug+vae')
...
improved_vae_validation_acc = np.genfromtxt('improved_vae_0/validation_acc.csv')
...
plt.plot(np.array(range(len(improved_vae_validation_acc))) + 1, improved_vae_validation_acc, label='improved+aug+vae')
plt.ylim(0.8, 1.0)
...
plt.plot(np.array(range(len(improved_vae_train_acc))) + 1, improved_vae_train_acc, label='train/improved+aug+vae')
...
plt.plot(np.array(range(len(improved_vae_validation_acc))) + 1, improved_vae_validation_acc, label='valid/improved+aug+vae')
plt.title('Training set accuracy')
plt.ylim(0.8, 1.0)
plt.xlim(0, 100)
plt.xlabel('epoch')
